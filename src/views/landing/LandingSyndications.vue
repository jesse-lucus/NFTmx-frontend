...
<template>
  <landing-section black>
    <div class="grid md:grid-cols-2 items-center 2xl:px-20">
      <div>
      ...
      <div class="sm:px-8">
        ...
        >
          ...
          consuming process, and introduces a potential deadlock of assets which
          can cause a loss in Metaverse profits.
        </div>
      </div>
    </div>
  </landing-section>
